...
!
!    Input, double precision X(N), the variable values.
!
!    Output, double precision FVEC(N), the function values at X,
!    if IFLAG = 1.
!
!    Output, double precision FJAC(LDFJAC,N), the N by N jacobian at X,
!    if IFLAG = 2.
!
...
!
  ...
  integer iflag
  double precision x(n)
  double precision, parameter, dimension ( 4 ) :: xdat = (/ &
    2.0D+00,  4.0D+00,  6.0D+00,  8.0D+00 /)
  double precision, parameter, dimension ( 4 ) :: ydat = (/ &
...
!
  ...
  integer iflag
  double precision x(n)
  double precision, dimension ( 4 ) :: xdat = (/ &
    2.0D+00,  4.0D+00,  6.0D+00,  8.0D+00 /)
  double precision, dimension ( 4 ) :: ydat = (/ &
    2.0D+00, 11.0D+00, 28.0D+00, 40.0D+00 /)
